...
from restfulengine import JsonDataSource
from restfulengine import ODataDataSource
from restfulengine import DataSet
...
class TestClient:
    ...
    json_file = test_data_dir + "JsonSample.docx"
    odata_file = test_data_dir + "ODataSample.docx"
    dataset_template = test_data_dir + "DataSet.docx"
    dataset_file = test_data_dir + "DataSet.rdlx"
    ...
    def test_post_template_with_json_data(self):
        ...
        with open(self.json_file, 'rb') as template:
            ...
            report.process(data_sources)
            # test is that we had no exceptions/errors (200)
