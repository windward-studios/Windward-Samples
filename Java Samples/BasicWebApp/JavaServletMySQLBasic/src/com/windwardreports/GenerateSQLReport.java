...
public class GenerateSQLReport extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			throw new ServletException("Please add the MySql JDBC connector to your classpath. Details at http://rpt.me/MySqlJDBC", e);
		}
        ...
        try {
            ...
            report.processSetup();
            DataSourceProvider dsp = new JdbcDataSource("com.mysql.jdbc.Driver",
                    "jdbc:mysql://mysql.windward.net/sakila", "demo", "demo");
            report.processData(dsp, "MYSQL");
            dsp.close();
        } catch (Exception se) {
            log("Setup error", se);
