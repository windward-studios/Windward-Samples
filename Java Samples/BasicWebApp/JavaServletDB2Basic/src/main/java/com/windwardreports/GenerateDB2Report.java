...
public class GenerateDB2Report extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			throw new ServletException("Please add the DB2 JDBC connector to your classpath. Details at http://rpt.me/DB2JDBC", e);
		}
        ...
        try {
            ...
            report.processSetup();
            //setup our DB2 datasource
            DataSourceProvider dsp = new JdbcDataSource("com.ibm.db2.jcc.DB2Driver",
                                "jdbc:db2://db2.windward.net:50000/SAMPLE", "demo", "demo");
            report.processData(dsp, "DB2");
            dsp.close();
        } catch (Exception se) {
            log("Setup error", se);
