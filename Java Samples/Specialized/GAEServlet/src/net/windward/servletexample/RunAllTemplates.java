...
public class RunAllTemplates extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        // Initialize the Google App Engine virtual file system
        GaeVFS.setRootPath(context.getRealPath("/"));
    }
    ...
    private void openHTMLResponse(PrintWriter out, String title) {
        ...
        out.println("<html>");
        out.println(String.format("<head><title>GAETestingServlet - %s</title></head>", title));
        out.println("<body>");
    }
    ...
    private void populateTemplates() {
        ...
        templatesMap.put("DB2", new URLDatasourceTemplate("/samples/templates/DB2 - Template.docx", GenerateReport.DatasourceType.DB2, GenerateReport.Format.DOCX, "demo", "demo", "db2.windward.net", "SAMPLE", ""));
        ...
        templatesMap.put("Access", new FileDatasourceTemplate("/samples/templates/Microsoft Access Datasource Connection - Template.docx", GenerateReport.DatasourceType.Access, GenerateReport.Format.DOCX, "/samples/data/Northwind - 2007.accdb", ""));
        ...
        templatesMap.put("MySQL", new URLDatasourceTemplate("/samples/templates/MySQL - Template.docx", GenerateReport.DatasourceType.MySQL, GenerateReport.Format.DOCX, "test", "test", "mysql.windward.net", "sakila", "MYSQL"));
        templatesMap.put("Oracle", new URLDatasourceTemplate("/samples/templates/Oracle - Template.docx", GenerateReport.DatasourceType.Oracle, GenerateReport.Format.DOCX, "hr", "hr", "oracle.windward.net:1521", null, ""));
        templatesMap.put("OData", new URLDatasourceTemplate("/samples/templates/OData - Template.docx", GenerateReport.DatasourceType.OData, GenerateReport.Format.DOCX, null, null, "http://odata.windward.net/Northwind/Northwind.svc/", null, ""));
        templatesMap.put("MongoDB", new URLDatasourceTemplate("/samples/templates/MongoDB - Template.docx", GenerateReport.DatasourceType.MongoDB, GenerateReport.Format.DOCX, "demo", "demo", "mssql.windward.net:27017", "Northwind", ""));
        templatesMap.put("JSON", new FileDatasourceTemplate("/samples/templates/JSON - Template.docx", GenerateReport.DatasourceType.JSON, GenerateReport.Format.DOCX, "http://json.windward.net/Northwind.json", ""));
