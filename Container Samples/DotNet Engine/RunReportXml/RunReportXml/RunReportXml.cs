...
namespace RunReportXml
{
    class RunReportXml
    {
        static void Main(string[] args)
        {
            ...
            // Open template file and create output file using path from inside container
            ...
            // The second parameter is "sax" to tell the process that our data is named sax.
            // This must match the name given to the datasource inside the template
